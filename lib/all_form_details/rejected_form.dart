...
class rejected_form extends StatefulWidget {
  const rejected_form({Key? key}) : super(key: key);

  @override
  State<rejected_form> createState() => _rejected_formState();
}

class _rejected_formState extends State<rejected_form> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Admission Canceled Form"),
        elevation: 0,
      ),
