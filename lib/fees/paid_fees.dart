...
class paid_fees extends StatefulWidget {
  const paid_fees({Key? key}) : super(key: key);

  @override
  State<paid_fees> createState() => _paid_feesState();
}

class _paid_feesState extends State<paid_fees> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Paid Fees Student Details"),
        elevation: 0,
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection("admission_form") .where("Payment_status",isEqualTo: "Done")
            .snapshots(),
