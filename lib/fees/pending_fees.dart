...
class pending_fees extends StatefulWidget {
  const pending_fees({Key? key}) : super(key: key);

  @override
  State<pending_fees> createState() => _pending_feesState();
}

class _pending_feesState extends State<pending_fees> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Pending Fees Student List"),
        elevation: 0,
      ),
      body: StreamBuilder(
