...
class accept_reject_form extends StatefulWidget {
  const accept_reject_form({Key? key}) : super(key: key);

  @override
  State<accept_reject_form> createState() => _accept_reject_formState();
}

class _accept_reject_formState extends State<accept_reject_form> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Accept/Reject Forms"),
        elevation: 0,
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where("Payment_status",isEqualTo: "")
            .snapshots(),
